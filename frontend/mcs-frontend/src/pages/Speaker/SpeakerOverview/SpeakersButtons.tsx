...
const SpeakersButton: React.FC<SpeakersButtonProps> = ({}) => {
    ...
    const [speakerEmailModal, setSpeakerEmailModal] = useState(false)
    ...
    const handleOpenSpeakerEmailModal = () => {
        setSpeakerEmailModal(true)
        handleEmailClose()
    }

    const handleCloseSpeakerEmailModal = () => {
        setSpeakerEmailModal(false)
    }
    ...
    return (
        <>
            <Box className="flex justify-end space-x-4">
                ...
                >
                    <MenuItem onClick={handleOpenSpeakerEmailModal}>
                        Email New Speaker
                    </MenuItem>
