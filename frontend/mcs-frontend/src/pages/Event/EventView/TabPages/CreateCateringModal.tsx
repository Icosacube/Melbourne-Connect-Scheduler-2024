...
export const CreateCateringModal: React.FC<CreateCateringModalProps>
    = ({ handleClose, open, eventID, fundingAccounts, addCatering }) => {
    const {
        handleSubmit,
        reset,
        control,
                    ...
                    <Box className='flex space-x-10 mb-4'>
                        ...
                        <Box className='space-y-4'>
                            <FormInputMultiSelect
                                ...
                                options={Array.from(fundingAccounts.entries()).map(([id, themisString]) => ({
                                    label: themisString,
                                    value: id,
                                }))}
                            />
                            <FormInputDate name='ExpenseDate' control={control} label='Expense Date' />
                        </Box>
                    </Box>
