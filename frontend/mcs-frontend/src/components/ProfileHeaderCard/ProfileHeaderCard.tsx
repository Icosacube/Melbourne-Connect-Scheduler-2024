...
export const ProfileHeaderCard: FC<ProfileHeaderCardProps> = ({ speaker }) => {
  ...
  return (
    <Card>
      <CardActionArea onClick={handleCardClick} sx={{ flexGrow: 1, width: '100%', height: '100%' }}>
        <CardContent>
          <Grid container spacing={2} alignItems="center">
            {/* Avatar and Speaker Details */}
            <Grid item>
              <Avatar sx={{ minWidth: '72px', minHeight: '72px' }}>A</Avatar>
            </Grid>
            <Grid item xs={6} sm container>
              <Grid item>
                <Typography
                  variant="subtitle2"
                  color="#FBAB18"
                  sx={{ fontFamily: 'Futura' }}
                >
                  {speaker.Title}
                </Typography>
                <Typography
                  variant="h6"
                  sx={{ fontFamily: 'Futura', lineHeight: 1.1 }}
                >
            ...
            <Grid item xs={12} sm={4}>
              ...
              >
                ...
                <Chip
                  label={speaker.Category === '' ? 'unknown category' : speaker.Category}
                  size="small"
                  sx={{ backgroundColor: '#FBE418', color: 'black' }}
                />
                <Chip
                  label={speaker.Area === '' ? 'unknown area' : speaker.Area}
                  size="small"
                  sx={{ backgroundColor: '#FBE418', color: 'black' }}
                />
